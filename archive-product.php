...
function recurse_cat($cat)
{
	...
	echo "<ul><li class='foldable foldable-list $highlight' target='{$cat->term_id}'><a href='$cat_url'>$cat_lowercase_name</a> $cat_icon</li>\n";
...
<script>
const usaMadeInInput=document.querySelector(".made__in--usa-input1"),madeInTheUSAInput=document.querySelector(".made__in--usa-label1"),madeInUSACount=document.querySelector(".wpf_item_count");let usaSwitchFunc=()=>{document.querySelector(".iCheck-helper").click()};madeInTheUSAInput.addEventListener("click",usaSwitchFunc);let isUSACheck;isUSACheck="https://typkup.com/shop/"!==window.location.href&&(!0===JSON.parse(localStorage.getItem("isUSACheck"))||0<window.location.href.indexOf("product_tag=usa")),localStorage.setItem("isUSACheck",isUSACheck),console.log(isUSACheck),document.querySelector(".made__in--usa-label1").addEventListener("click",()=>console.log("clicked"));let isUSACheck_d=JSON.parse(localStorage.getItem("isUSACheck"));isUSACheck_d&&window.location.href.indexOf("product_tag=usa")<0&&window.location.assign(window.location.href+"?swoof=1&product_tag=usa"),0<window.location.href.indexOf("product_tag=usa")&&(document.getElementById("switch").checked=!0,madeInTheUSAInput.addEventListener("click",()=>{isUSACheck=!1,localStorage.setItem("isUSACheck",isUSACheck)}));
</script>
